...
- After login, landing in this page
...
The github URL should be of your repository with `https://github.com/your_user_name/...git
...
- Keep dependencies in your head (error-prone!) ❌ R
